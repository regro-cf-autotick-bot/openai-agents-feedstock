...
pixi add openai-agents
# for installing globally
pixi global install openai-agents
```
...
It is possible to list all of the versions of `openai-agents` available on your platform:
...
```
pixi search openai-agents --channel conda-forge
```
